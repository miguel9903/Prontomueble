	...
	<tbody>
			...
			?>
				<tr>
			    	...
			    	<td><a href="index.php?pid=<?php echo base64_encode("presentacion/vendedor/generarFactura.php") . "&idVenta=" . $tp->getId();?>" class="btn btn-success"><i class="fas fa-file-download"></i> Factura</a></td>	
				</tr>		
			<?php  
				}						
			?>
