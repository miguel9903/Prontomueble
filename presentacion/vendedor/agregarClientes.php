		...
		<div class="col-3">
			<div class="card ">
				...
				<div class="card-body">
					...
					<form method="post" action="index.php?pid=<?php echo base64_encode("presentacion/vendedor/agregarClientes.php") ?>">
						<div class="form-group">
							<label>Cedula:</label> 
...
$(document).ready(function(){
	$("#filtro").keyup(function(){
		if($("#filtro").val()!=""){
			var ruta = "indexAjax.php?pid=<?php echo base64_encode("presentacion/vendedor/buscarClienteAjax.php"); ?>&filtro="+$("#filtro").val();
