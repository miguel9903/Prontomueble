...
$(document).ready(function(){
	$("#filtro").keyup(function(){
		if($("#filtro").val()!=""){
			var ruta = "indexAjax.php?pid=<?php echo base64_encode("presentacion/administador/buscarMuebleAjax.php"); ?>&filtro="+$("#filtro").val();
...
$(document).ready(function(){
	$("#btnModificarMueble").click(function(){
		$.ajax({
			...
			url: "indexAjax.php?pid=<?php echo base64_encode("presentacion/administador/modificarMuebleAjax.php");?>",
