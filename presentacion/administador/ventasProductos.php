...
$(document).ready(function(){
	...
	$("#tablaVentasCarrito").load("index.php?pid=<?php echo base64_encode("presentacion/administador/tablaCarrito.php");?>");
 	...
 	$("#productoVenta").change(function (){
		...
		$.ajax({
			...
			url: "indexAjax.php?pid=<?php echo base64_encode("presentacion/administador/llenarFormularioMuebleAjax.php");?>",
 	...
 	$("#btnAgregarProducto").click(function (){	
		...
		$.ajax({
			...
			url: "index.php?pid=<?php echo base64_encode("presentacion/administador/agregarProductoTemp.php");?>",
			success: function(res){
				$("#tablaVentasCarrito").load("index.php?pid=<?php echo base64_encode("presentacion/administador/tablaCarrito.php");?>");
			}
		});
 	...
 	$("#btnVacTablaVenta").click(function (){	
 		$.ajax({
 			url: "index.php?pid=<?php echo base64_encode("presentacion/administador/vaciarTablaVentas.php");?>",
 			success: function(res){
 				$("#tablaVentasCarrito").load("index.php?pid=<?php echo base64_encode("presentacion/administador/tablaCarrito.php");?>");
 			}
 		 	});
...
<script type="text/javascript">
	function qutarProducto(indice){
		$.ajax({
			type: "POST",
			data: "indice=" + indice,
			url: "index.php?pid=<?php echo base64_encode("presentacion/administador/quitarProducto.php");?>",
			success: function(res){
				$("#tablaVentasCarrito").load("index.php?pid=<?php echo base64_encode("presentacion/administador/tablaCarrito.php");?>");
	...
	function registrarVenta(){
		$.ajax({
			url: "index.php?pid=<?php echo base64_encode("presentacion/administador/registrarVenta.php");?>",
			success: function(res){
				$("#tablaVentasCarrito").load("index.php?pid=<?php echo base64_encode("presentacion/administador/tablaCarrito.php");?>");
